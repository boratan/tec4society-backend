...
DATABASE = os.getenv('DB_DATABASE', 'dbi344256')
USERNAME = os.getenv('DB_USERNAME', 'dbi344256')
PASSWORD = os.getenv('DB_PASSWORD', 'koen1234')
HOST = os.getenv('DB_HOST', 'studmysql01.fhict.local')
